...
export const ART = {
  ...
  brand: spec({
    ...
    gatewaysCrest: { src: "https://cdn.jsdelivr.net/gh/abhinavjn45/gateways2026-assets@main/art/splash/Gateways_Pixel.png", w: 1254, h: 1254, kind: "sprite", note: "Gateways crest, gold" },
    gatewaysCrestBlack: { src: "https://cdn.jsdelivr.net/gh/abhinavjn45/gateways2026-assets@main/art/splash/gateways_black.png", w: 1254, h: 1254, kind: "sprite", note: "Gateways crest, black — light theme" },
